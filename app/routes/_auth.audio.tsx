...
export default function AudioPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">{t("audio.title")}</h1>
        <p className="text-gray-700 dark:text-white/95 mt-1">{t("audio.subtitle")}</p>
      </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              {devices.playback.length === 0 ? (
                <p className="text-sm text-gray-700 dark:text-gray-400">{t("audio.noInputDevices")}</p>
              ) : (
                devices.playback.map((device) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-700 dark:text-gray-400">{device.id}</p>
                    </div>
                    {device.isDefault && (
        ...
        <CardContent>
          <div className="grid gap-4 text-sm">
            <div className="flex justify-between">
              <span className="text-gray-700 dark:text-gray-400">{t("audio.outputDevices")}:</span>
              <span className="font-medium text-gray-900 dark:text-white">{devices.playback.length}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-700 dark:text-gray-400">{t("audio.inputDevices")}:</span>
              <span className="font-medium text-gray-900 dark:text-white">{devices.capture.length}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-700 dark:text-gray-400">{t("audio.currentOutput")}:</span>
              <span className="font-medium text-gray-900 dark:text-white">{settings.outputDevice}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-700 dark:text-gray-400">{t("audio.currentInput")}:</span>
              <span className="font-medium text-gray-900 dark:text-white">{settings.inputDevice}</span>
            </div>
          </div>
        </CardContent>
      </Card>
